...
public class Color {
  ...
  public boolean equals(Object o){
	  Color c = (Color)o;
	  return Math.abs(red - c.red) <= 5 && Math.abs(green - c.green) <= 5 && Math.abs(c.blue - blue) <= 5;
  }

  private static final int WHITEV = 220;
  
  public static boolean isWhite(Color c){
	  return c.red >= WHITEV && c.blue >= WHITEV && c.green >= WHITEV;
  }
